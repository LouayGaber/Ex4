...
public class Winner_case3 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Winner_case3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      //show on screen the winner
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Winner_case3().setVisible(true);
            }
        });
    }
