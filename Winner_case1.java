...
public class Winner_case1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Winner_case1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Winner_case1().setVisible(true);
            }
        });
    }
