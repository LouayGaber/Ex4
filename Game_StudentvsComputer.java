/**
 *Student vs Computer Round 
 *Author : Louay Gaber
 *318205614
 */
public class Game_StudentvsComputer extends javax.swing.JFrame {
...
private int [] game; //choose numbers from this array
  ...
  public Game_StudentvsComputer() {
     ...
     * @param event - the click operation
     */
    private void top_button_ActionPerformed(java.awt.event.ActionEvent event) {                                            
	...
	i++;
        ...
        if (i < j) {
            ...
            Winner_case3 w = new Winner_case3(); 
            w.setVisible(true);
        }
    }                                           
     ...
     * @param event - the click operation
     */
    private void lower_button_ActionPerformed(java.awt.event.ActionEvent event) {                                              
        user_chosed_message_.setText("");
    ...
    private void showList(int start, int end) {
     ...
     //Otherwise if the sum of the numbers in the second pair (indexes) is greater then he chooses a number from there       
        ...
        user_chosed_message_.setText(" please select a number"); //the player turn message
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Game_StudentvsComputer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Game_StudentvsComputer().setVisible(true);
            }
        });
    }
