 ...
 */
public class Game_StudentvsStudent extends javax.swing.JFrame {
	...
	i++;
        ...
        if (i <= j) {
            ...
            if (sum1 > sum2) {
                Winner_case1 w1 = new Winner_case1();
                w1.setVisible(true);
                //second student is the winner
            } else if(sum1 < sum2) {
                Winner_case2 w2 = new Winner_case2();
                w2.setVisible(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Game_StudentvsStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Game_StudentvsStudent().setVisible(true);
            }
        });
    }
